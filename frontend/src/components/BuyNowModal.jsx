...
export const BuyNowModal = ({
  ...
  const deliveryFee = itemTotal >= 500 || (appliedCoupon && appliedCoupon.code === 'FREESHIP') ? 0 : 40;
  ...
  if (appliedCoupon) {
    if (appliedCoupon.type === 'flat') {
      ...
      discountAmount = Math.min(appliedCoupon.maxDiscount || 150, (itemTotal * appliedCoupon.value) / 100);
    }
  }
