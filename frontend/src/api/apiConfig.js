...
export const getApiBaseUrl = () => {
  const ACTIVE_LIVE_BACKEND = 'https://54-82-202-70.sslip.io/api';
  ...
  if (typeof window !== 'undefined') {
    ...
    if (envUrl) {
      ...
      // Replace legacy HTTP EC2 IP with new HTTPS sslip.io domain automatically
      if (cleanEnvUrl.includes('54.82.202.70') || cleanEnvUrl.includes('http://54.82.202.70')) {
        cleanEnvUrl = cleanEnvUrl.replace(/http:\/\/54\.82\.202\.70(:8080)?/, 'https://54-82-202-70.sslip.io');
      }
