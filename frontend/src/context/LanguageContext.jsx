...
export const translations = {
  en: {
    ...
    publicReviewsTitle: "Real Customer Reviews & Ratings",
    publicReviewsSubtitle: "Verified feedback from genuine Sanjeevani purchasers",
    writeReview: "Write a Product Review",
    yourName: "Your Full Name",
    yourComment: "Write your feedback, dosage experience, or review...",
    postReview: "Post Customer Review",
    noReviewsYet: "No public reviews posted for this item yet. Be the first to share your experience!",
    reviewSubmitted: "Thank you for your review!",
    reviewSubmittedMsg: "Your customer review has been successfully submitted and posted.",
  },
  hi: {
    storeName: "संजीवनी",
    ...
    publicReviewsTitle: "वास्तविक ग्राहक समीक्षाएं और रेटिंग",
    publicReviewsSubtitle: "संजीवनी खरीदारों द्वारा दी गई प्रामाणिक राय",
    writeReview: "उत्पाद समीक्षा लिखें",
    yourName: "आपका पूरा नाम",
    yourComment: "अपनी प्रतिक्रिया या अनुभव लिखें...",
    postReview: "समीक्षा पोस्ट करें",
    noReviewsYet: "अभी तक इस उत्पाद पर कोई समीक्षा पोस्ट नहीं की गई है।",
    reviewSubmitted: "समीक्षा के लिए धन्यवाद!",
    reviewSubmittedMsg: "आपकी समीक्षा सफलतापूर्वक सबमिट हो गई है।",
  },
  te: {
    storeName: "సంజీవని",
    ...
    publicReviewsTitle: "కస్టమర్ సమీక్షలు & రేటింగ్‌లు",
    publicReviewsSubtitle: "సంజీవని కొనుగోలుదారుల నుండి నిజమైన అభిప్రాయం",
    writeReview: "సమీక్ష రాయండి",
    yourName: "మీ పూర్తి పేరు",
    yourComment: "మీ అనుభవాన్ని రాయండి...",
    postReview: "సమీక్షను పోస్ట్ చేయండి",
    noReviewsYet: "ఈ వస్తువుకు ఇంకా ఎటువంటి సమీక్షలు లేవు.",
    reviewSubmitted: "ధన్యవాదాలు!",
    reviewSubmittedMsg: "మీ సమీక్ష విజయవంతంగా పోస్ట్ చేయబడింది.",
  },
  kn: {
    storeName: "ಸಂಜೀವನಿ",
    ...
    publicReviewsTitle: "ಗ್ರಾಹಕರ ವಿಮರ್ಶೆಗಳು ಮತ್ತು ರೇಟಿಂಗ್‌ಗಳು",
    publicReviewsSubtitle: "ಸಂಜೀವನಿ ಖರೀದಿದಾರರ ನೈಜ ಪ್ರತಿಕ್ರಿಯೆ",
    writeReview: "ವಿಮರ್ಶೆ ಬರೆಯಿರಿ",
    yourName: "ನಿಮ್ಮ ಪೂರ್ಣ ಹೆಸರು",
    yourComment: "ನಿಮ್ಮ ಪ್ರತಿಕ್ರಿಯೆಯನ್ನು ಬರೆಯಿರಿ...",
    postReview: "ವಿಮರ್ಶೆಯನ್ನು ಪೋಸ್ಟ್ ಮಾಡಿ",
    noReviewsYet: "ಈ ಉತ್ಪನ್ನಕ್ಕೆ ಇನ್ನೂ ಯಾವುದೇ ವಿಮರ್ಶೆಗಳಿಲ್ಲ.",
    reviewSubmitted: "ಧನ್ಯವಾದಗಳು!",
    reviewSubmittedMsg: "ನಿಮ್ಮ ವಿಮರ್ಶೆಯನ್ನು ಯಶಸ್ವಿಯಾಗಿ ಸಲ್ಲಿಸಲಾಗಿದೆ.",
  }
};
