...
export const formatCategoryName = (name) => {
  ...
  if (str.includes('Nutrition') || str.includes('Health Supplements')) return 'Nutrition & Health';
  if (str.includes('Baby') || str.includes('Pediatric') || str.includes('Kid')) return "Kid's Essentials";
  return str;
};
