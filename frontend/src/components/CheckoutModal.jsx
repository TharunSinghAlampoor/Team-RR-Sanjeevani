...
import { X, ShoppingBag, MapPin, CreditCard, Shield, Package, AlertTriangle, CheckCircle2, Loader2, QrCode, Smartphone, XCircle, Copy, Check, DollarSign } from 'lucide-react';
...
export const CheckoutModal = ({
  ...
  const [paymentMode, setPaymentMode] = useState('razorpay'); // 'razorpay' | 'qr' | 'cod' | 'amazonpay'
  ...
  const handlePayWithRazorpay = async () => {
    ...
    try {
      ...
      // If COD / Pay on Delivery selected, execute direct order checkout
      if (paymentMode === 'cod') {
        ...
        <div style={s.body}>
          ...
          {paymentMode === 'razorpay' && (
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <span style={{ fontSize: '0.7rem', color: '#059669', fontWeight: 800, background: '#ecfdf5', padding: '2px 8px', borderRadius: 99, border: '1px solid #a7f3d0' }}>
          ...
          {paymentMode === 'cod' && (
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <span style={{ fontSize: '0.82rem', fontWeight: 900, color: '#047857', display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
                  💵 {translateData('Pay on Delivery (COD) Options')}
                </span>
                <span style={{ fontSize: '0.7rem', fontWeight: 800, color: '#15803d', background: '#dcfce7', padding: '2px 8px', borderRadius: 99, border: '1px solid #86efac' }}>
